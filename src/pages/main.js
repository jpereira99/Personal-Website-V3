		...
		posts: [
			{
				url: '/projects/cpe322',
				img:
					'https://images.unsplash.com/photo-1553406830-f6e44ac97624?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1489&q=80',
				title: 'CPE 322',
				desc: 'Engineering Design VI with Professor Kevin Lu',
				date: '- Active Project -',
			},
			{
				url: '/projects/cpe487',
			...
			},
			{
				...
				img:
					'https://challengepost-s3-challengepost.netdna-ssl.com/photos/production/software_photos/000/766/295/datas/gallery.jpg',
				title: 'Rolodecks',
				desc: 'DuckHacks 2019',
				date: '02/17/19',
			},
			{
				...
				img:
					'https://challengepost-s3-challengepost.netdna-ssl.com/photos/production/software_photos/000/724/982/datas/gallery.jpg',
				title: 'Flow',
			...
			<div className='mainContainer'>
				...
				<div id='education'>
					<div className='educationTextContainer'>
						<img
							...
							src='https://web.stevens.edu/news/newspoints/brand-logos/Stevens-Apparel-White-R.png'
						/>
				...
				<div id='truthable'>
					<div className='truthableTextContainer'>
						...
						<div className='truthableText'>
							...
							<p>
								We strive to give people the peace of mind in knowing the information they receive is always true. We build
								the foundations to seek the truth.
							</p>
							<a className='truthableLinkText' href='https://truthable.ai'>
								Visit our Website
							</a>
						</div>
					</div>
				...
				<div id='design'>
					...
					<div id='designTextContainer'>
						...
						<p className='designSubtitleText'>
							I enjoy doing graphic design in my free time. Whether it be football kits, personal/company logos, or designing
							album covers.
						</p>
						<p className='designSubtitleText'>
							<p className='designBoldText'>Monthly Playlist Project</p>I started this project to constantly discover more
							music and learn new graphic design techniques and express different ideas.
						</p>
						<a className='designLinkText' href='https://open.spotify.com/user/1253099173?si=wgx4FKApRi6uwCeg8hYqWA'>
							Discover my playlists and their album covers here
						</a>
					</div>
				</div>
				...
				<div id='projects'>
					<div className='projectsContainer'>
						...
						<p className='projectsSubtitleText'>
							Click to see more about one of my public projects. Lots of time has been spent towards Truthable, so most are
							connected in some way to class assignments.
						</p>
						<a className='projectsLinkText' href='https://github.com/jpereira99'>
